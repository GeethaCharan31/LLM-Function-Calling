...
os.environ['HF_HOME'] = '/data3/home/geethacharan/cache'
...
class ModelInference:
    ...
    def execute_function_call(self, tool_call):
        ...
        print("##### \n \n ERROR OCCURING AFTER THIS LINE \n \n ")
        # print(f"##### \n \n TYPE \n\n {type(function_args['tool_input'])} \n \n ")

        # args = json.loads(json.dumps(tool_call.get("arguments", {})))
        # print(f"@@@@@@@@@@ ARGS \n\n{args}")

        function_response = function_to_call.invoke(*function_args.values()) #*function_args.values()
        # function_response = function_to_call(function_args.get('initial_date'),function_args.get('final_date'))
        
        
        print("##### \n \n ERROR OCCURING BEFORE THIS LINE \n \n ")
        
        ####
        import streamlit as st
        st.chat_message("assistant").write(function_response)
    ...
    def generate_function_call(self, query, chat_template, num_fewshot, max_depth=2):
        try:
            depth = 0
            ...
            # prompting with the user_message and tools
            ...
            def recursive_loop(prompt, completion, depth):
                ...
                if tool_calls:
                    inference_logger.info(f"Assistant Message 1 :\n{assistant_message}")
                    ...
                    inference_logger.info(f"Assistant Message 2:\n{assistant_message}")
